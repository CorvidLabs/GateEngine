...
class DX12Geometry: GeometryBackend, SkinnedGeometryBackend {
    ...
    required init(geometry: RawGeometry) {
        ...
        self.buffers = [
            DX12Renderer.createBuffer(
                withData: geometry.positions,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: geometry.uvSet1,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: geometry.uvSet2,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: geometry.tangents,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: geometry.normals,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: geometry.colors,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
    ...
    required init(geometry: RawGeometry, skin: Skin) {
        ...
        self.buffers = [
            ...
            DX12Renderer.createBuffer(
                withData: skin.jointIndices,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: skin.jointWeights,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
    ...
    required init(lines: RawLines) {
        ...
        self.buffers = [
            DX12Renderer.createBuffer(
                withData: lines.positions,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: lines.colors,
                heapProperties: .forBuffer,
                state: .genericRead
            ),

            DX12Renderer.createBuffer(
                withData: lines.indices,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
        ]
    ...
    required init(points: RawPoints) {
        ...
        self.buffers = [
            DX12Renderer.createBuffer(
                withData: points.positions,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
            DX12Renderer.createBuffer(
                withData: points.colors,
                heapProperties: .forBuffer,
                state: .genericRead
            ),

            DX12Renderer.createBuffer(
                withData: points.indices,
                heapProperties: .forBuffer,
                state: .genericRead
            ),
        ]
